...
const ReportProductPanelTool: FC<IReportProductPanelToolProps> = (
    ...
    const {register, handleSubmit, formState: {errors}, reset, setError, watch, resetField} = useForm();
    ...
    const foundBsu = bsu && bsu.filter(item => item.codePlant === codePlant) || []
    console.log(foundBsu)
