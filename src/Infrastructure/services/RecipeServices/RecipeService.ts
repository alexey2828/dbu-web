...
export const recipeAPI = createApi({
    ...
    endpoints: (build) => ({
        fetchAllRecipe: build.query<[], any>({
            query: (id) => ({
        ...
        editRecipeDescription: build.mutation<[], any>({
            query: (body) => ({
                url: 'edit/editRecipeDescription.php',
                method: 'PUT',
                body
            }),
            invalidatesTags: ['recipe']
        ...
        editRecipe: build.mutation<[], any>({
            query: (body) => ({
                url: 'edit/editRecipe.php',
                method: 'PUT',
                body
            }),
            invalidatesTags: ['recipe']
